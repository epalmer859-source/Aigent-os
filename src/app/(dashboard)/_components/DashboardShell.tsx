...
const NAV_MAIN = [
  ...
  { label: "Appointments",  href: "/dashboard/appointments",  Icon: IconAppointments,  urgentBadge: false },
  { label: "Quotes",        href: "/dashboard/quotes",        Icon: IconQuotes,        urgentBadge: false },
  { label: "Approvals",     href: "/dashboard/approvals",     Icon: IconApprovals,     urgentBadge: false },
