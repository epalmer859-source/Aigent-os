...
import { signupPageAction } from "~/server/auth/actions";

export default function SignupPage() {
  const [state, formAction, isPending] = useActionState(signupPageAction, null);
    ...
    <div className="min-h-screen bg-[#09090B] flex flex-col items-center justify-center px-4">
      ...
      <div className="w-full max-w-md bg-zinc-900 border border-zinc-800 rounded-2xl p-8">
        ...
        <p className="text-sm text-zinc-500 mb-8">
          Create your account and set up your AI front desk
        </p>
